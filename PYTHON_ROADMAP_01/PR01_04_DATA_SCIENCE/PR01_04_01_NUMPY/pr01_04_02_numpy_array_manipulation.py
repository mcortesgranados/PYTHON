...
# Example: NumPy Array Manipulation
...
# 7. Adding new dimensions to arrays
...
# Documenting the NumPy Array Manipulation:
def numpy_array_manipulation_documentation():
    ...
    - Flattening arrays using numpy.flatten().
    - Transposing arrays using numpy.transpose().
